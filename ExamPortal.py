...
def institution_home():
    ...
    res = a.selectOne(qry)
    return render_template('institution/institution_home.html',inst=res)
...
def manager_home():
    ...
    res = a.selectOne(qry)
    return render_template('manager/manager_home.html',manager=res)
...
def hod_home():
    ...
    res = a.selectOne(qry)
    return render_template('hod/hod_home.html',hod=res)
...
def t_home_teacher():
    ...
    res = a.selectOne(qry)
    return render_template('teacher/home_teacher.html',teacher=res)
...
def st_home_student():
    ...
    res = a.selectOne(qry)
    return render_template('student/student_home.html',student=res)
